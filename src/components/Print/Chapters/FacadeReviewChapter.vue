      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="grid grid-cols-6 items-center gap-4">
          ...
          <dl role="list" class="list--definition col-span-4">
            <div 
              v-for="field in sampleFieldsWithData['back']" 
              :key="field.name"
              class="item--grid">
              <dt>{{ field.label }}</dt>
              <dd>{{ field.value }}</dd>
        ...
        <div class="grid grid-cols-6 items-center gap-4">
          ...
          <dl role="list" class="list--definition col-span-4">
            <div 
              v-for="field in sampleFieldsWithData['indoor']" 
              :key="field.name"
              class="item--grid">
              <dt>{{ field.label }}</dt>
              <dd>{{ field.value }}</dd>
        ...
        <div class="grid grid-cols-6 items-center gap-4">
          ...
          <dl role="list" class="list--definition col-span-4">
            <div 
              v-for="field in sampleFieldsWithData['left']" 
              :key="field.name"
              class="item--grid">
              <dt>{{ field.label }}</dt>
              <dd>{{ field.value }}</dd>
        ...
        <div class="grid grid-cols-6 items-center gap-4">
          ...
          <dl role="list" class="list--definition col-span-4">
            <div 
              v-for="field in sampleFieldsWithData['right']" 
              :key="field.name"
              class="item--grid">
              <dt>{{ field.label }}</dt>
              <dd>{{ field.value }}</dd>
        ...
        <div class="grid grid-cols-6 items-center gap-4">
          ...
          <dl role="list" class="list--definition col-span-4">
            <div 
              v-for="field in sampleFieldsWithData['front']" 
              :key="field.name"
              class="item--grid">
              <dt>{{ field.label }}</dt>
              <dd>{{ field.value }}</dd>
        ...
        <div class="highlight__content space-y-3">
          ...
          <dl role="list" class="list--definition">
            <div class="grid grid-cols-2 gap-4">
              <div>
                <div 
                  v-for="field in sampleFieldsWithData['skewed-left']" 
                  :key="field.name"
                  class="item--grid">
                  <dt>{{ field.label }}</dt>
                  <dd>{{ field.value }}</dd>
              ...
              <div>
                <div 
                  v-for="field in sampleFieldsWithData['skewed-right']" 
                  :key="field.name"
                  class="item--grid">
                  <dt>{{ field.label }}</dt>
                  <dd>{{ field.value }}</dd>
